...
Collection d'exercices Java axés sur les tableaux, les chaînes de caractères et les algorithmes de base.
...
- Saisie et affichage de chaînes
  
  <img width="651" height="342" alt="image" src="https://github.com/user-attachments/assets/b32da542-aea8-47af-990d-c2baa164bc11" />
  

  <img width="625" height="304" alt="image" src="https://github.com/user-attachments/assets/be0c5a68-2db4-49b3-b38c-c7f53a0f775f" />
...
1. Cloner le dépôt :
```bash
git clone https://github.com/mustapha005/Tpjava_Mustapha_Aarab.git
```

2. Ouvrir dans IntelliJ IDEA

3. Naviguer vers n'importe quel exercice :
   - `src/main/java/com/example/tpjava/exercises/Exercise1.java`

4. Clic droit → **Run** (Exécuter)
...
- Tableaux et manipulation de tableaux
- Traitement des chaînes de caractères
- Entrées/Sorties utilisateur avec Scanner
- Programmes avec menu interactif
